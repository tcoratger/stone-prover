    ...
    with open(file_path, "r") as file:
        ...
        if matches:
            ...
            if has_files:
                ...
                output_file.write(
                    '"-Wall","-Wextra","-fPIC","-I./src","-I/tmp/benchmark/include","-I/tmp/gflags/include","-I/tmp/glog/src","-I/tmp/glog","-I/tmp/googletest/googletest/include","-I/tmp/googletest/googlemock/include","-fno-strict-aliasing",},'
                )
                output_file.write("});\n")
                output_file.write("\n")
